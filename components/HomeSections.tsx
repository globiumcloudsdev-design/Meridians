...
// import { API_POSTERS_ACTIVE, API_BLOG } from "@/lib/api/endpoints";

// import { getCurrentAcademicSession, getImageSrc } from "@/lib/utils";

// import { homeAssets, homeAllImages, homeFeatureImages, homeFacilityImages } from "@/lib/assets";

// import { IPoster, BlogPost } from "@/lib/types";
...
//     badge: `Admissions Open ${academicSession}`,
...
//               <span>Admissions Open {academicSession}</span>
...
//                 <Counter value={stat.value} delay={idx * 0.2 + 0.5} />
...
//                 src={getImageSrc(homeAssets["Empowering the Next Generations"][0])}

//                 alt="Empowering the Next Generations"
          ...
          <div className="absolute right-4 sm:right-8 lg:right-12 bottom-32 hidden lg:block">
            <AnimatePresence mode="wait">
              ...
              >
                <div className="flex flex-col gap-6">
                  <div className="flex -space-x-4">
                    {["https://static.vecteezy.com/system/resources/thumbnails/048/001/415/small/pakistani-male-student-smiling-at-desk-in-classroom-setting-education-learning-diversity-photo.jpg", "https://www.shutterstock.com/image-photo/pakistani-young-beautiful-university-girls-260nw-2565535789.jpg","https://www.shutterstock.com/image-photo/pakistani-student-girl-university-sitting-260nw-2648416149.jpg","https://www.shutterstock.com/image-photo/happy-young-bearded-student-standing-260nw-2173903601.jpg"].map((i) => (
                      <motion.div
                        key={i}
                        className="w-16 h-16 rounded-full border-4 border-white/20 bg-muted overflow-hidden blur-none shadow-xl group-hover/stats:scale-110 transition-transform"
                      >
...
// Updated Counter component with start trigger
const Counter = ({
  value,
  duration = 2,
  delay = 0,
...
// Updated Stats component with scroll trigger
export const Stats: React.FC = () => {
