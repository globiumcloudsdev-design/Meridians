...
import { API_ADMISSION, API_CLASSES } from "@/lib/api/endpoints";
...
export default function AdmissionForm() {
  ...
  const [classes, setClasses] = useState<{_id: string; name: string; fees?: number}[]>([]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const contact1 = formData.fatherContact ? `+92${formData.fatherContact}` : "";
              ...
              <AnimatedSection direction="left">
                ...
                <div className="relative p-1 rounded-[40px] bg-gradient-to-br from-primary/20 via-transparent to-secondary/20 shadow-2xl">
                  ...
                  <Card className="border-none rounded-[39px] bg-card/80 backdrop-blur-xl overflow-hidden">
                    ...
                    <CardHeader className="px-8 pt-8 md:px-12 pt-12 ">
                          ...
                          {activeTab === "personal" && (
                            ...
                            <div className="space-y-6">
                              ...
                              <div className="space-y-4">
                                ...
                                <div className="h-[1px] w-full bg-gradient-to-r from-primary/20 via-primary/10 to-transparent mb-4" />
                                  ...
                                  <div className="space-y-2.5">
                                    ...
                                    <div className="relative flex items-center">
                                      ...
                                      <Input
                                        ...
                                        className="h-14 rounded-2xl border-primary/10 bg-primary/5 focus:bg-white transition-all focus:ring-2 focus:ring-primary/20 pl-[5.5rem]"
